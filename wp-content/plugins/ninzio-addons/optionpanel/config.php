	...
	class Redux_Framework_config {
        ...
        public function setSections() {
            ...
            <?php if ($screenshot) : ?>
                ...
                <div>
					...
					<?php if ( $ct->parent() ) {
						printf( ' <p class="howto">' . esc_html__( 'This <a href="%1$s">child theme</a> requires its parent theme, %2$s.', 'ninzio_addons' ) . '</p>',
							esc_html__( 'http://codex.wordpress.org/Child_Themes', 'ninzio_addons' ),
            ...
            $this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'options'  => array(
							'none'      => esc_html__('None', 'ninzio-addons'),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'h1-desk-height',
						'type'     => 'slider',
						'title'    => esc_html__('Header height', 'ninzio-addons'),
						'min'      =>'60', 
						'max'      =>'250', 
						'step'     =>'10',
						'default'  =>'90'
					...
					array(
						'id'       =>'h1-stucked-boxed',
						'type'     => 'switch',
						'title'    => esc_html__('Boxed stuck header', 'ninzio-addons'),
						'subtitle' => esc_html__('Toggle boxed stuck header', 'ninzio-addons'),
						"default"  => 0
					),
					...
					array(
						'id'      =>'h1-full-width',
						'type'    => 'switch', 
						'title'   => esc_html__('Header full width', 'ninzio-addons'),
						"default" => 0,
					),
					...
					array(
						...
						'type'    => 'link_color', 
						'title'   => esc_html__('Header top menu colors', 'ninzio-addons'),
						'active'   => false,
						'visited'  => false,
						'default'  => array(
					        'regular'  => '#999999',
					...
					array(
						'id'      =>'h1-desk-sidebar-toggle',
						'type'    => 'switch', 
						'title'   => esc_html__('Main sidebar toggle', 'ninzio-addons'),
						"default" => 0,
					),
					...
					array(
						'id'       =>'h1-desk-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h1-desk-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle border color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h1-desk-separator-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header menu icons separator color', 'ninzio-addons'), 
					),
					...
					array(
						'id'       =>'h1-desk-submenu-effect-color',
						'type'     => 'color',
						'title'    => esc_html__('Header submenu effect color', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),

					array(
						'id'       =>'h1-desk-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
							'fill'      =>'Fill'
						),
					...
					array(
						...
						'type'     => 'select',
						'title'    => esc_html__('Choose submenu effect', 'ninzio-addons'),
						'options'  => array(
							'ghost' =>'Ghost',
							'fade'  =>'Fade',
							'slide' =>'Slide',
					...
					array(
						'id'       =>'h1-desk-menu-m',
						'type'     => 'slider',
						'title'    => esc_html__('Set menu margin in px for desktop under 1600px wide', 'ninzio-addons'),
						'min'      =>'-10', 
						'max'      =>'250', 
						'step'     =>'1',
						'default'  =>'20'
					...
					array(
						'id'       =>'h1-desk-menu-m-1600',
						'type'     => 'slider',
						'title'    => esc_html__('Set menu margin in px for desktop over 1600px wide', 'ninzio-addons'),
						'min'      =>'-10', 
						'max'      =>'250', 
						'step'     =>'1',
						'default'  =>'20'
					...
					array(
						'id'       =>'h1-desk-megamenu-top-border',
						'type'     => 'color',
						'title'    => esc_html__('Megamenu top level border bottom', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h1-desk-megamenu-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose megamenu submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
							'fill'      =>'Fill'
						),
					...
					array(
						'id'       =>'h1-megamenu-buttons-back-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons background color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),

					array(
						'id'       =>'h1-megamenu-buttons-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons text color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#ffffff',
					),

					array(
						'id'      =>'h1-megamenu-icons-version',
						'type'     => 'select',
						'title'    => esc_html__('Choose icons version for megamenu widgets', 'ninzio-addons'),
						'options'  => array(
							"dark"  => "Dark",
							"light" => "Light"
						),
					...
					array(
						'id'       =>'h1-fixed-height',
						'type'     => 'slider',
						'title'    => esc_html__('Fixed height', 'ninzio-addons'),
						'min'      =>'60', 
						'max'      =>'250', 
						'step'     =>'10',
						'default'  =>'90'
					...
					array(
						'id'       =>'h1-desk-fixed-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h1-desk-fixed-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle border color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h1-desk-fixed-separator-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header menu icons separator color', 'ninzio-addons'), 
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'h2-desk-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h2-desk-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle border color', 'ninzio-addons'), 
					),
					...
					array(
						'id'       =>'h2-desk-submenu-effect-color',
						'type'     => 'color',
						'title'    => esc_html__('Header submenu effect color', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),
					...
					array(
						'id'       =>'h2-desk-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
					...
					array(
						'id'       =>'h2-desk-megamenu-top-border',
						'type'     => 'color',
						'title'    => esc_html__('Megamenu top level border bottom', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h2-desk-megamenu-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose megamenu submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
					...
					array(
						'id'       =>'h2-megamenu-buttons-back-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons background color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),
					...
					array(
						'id'       =>'h2-megamenu-buttons-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons text color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#ffffff',
					),
					...
					array(
					    'id'   => 'h2-info-fixed-logo',
					    'type' => 'info',
					    'desc' => esc_html__('Upload .jpg, .png or .gif image that will be your logo.', 'ninzio-addons')
					),

					array(
						'id'       =>'h2-desk-fixed-logo',
						'type'     => 'media', 
						'url'      => false,
						'title'    => esc_html__('Sticky Header logo upload', 'ninzio-addons'),
					),
					...
					array(
						'id'       =>'h2-desk-fixed-back-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky Header menu background color', 'ninzio-addons'), 
					),

					array(
						'id'      =>'h2-desk-fixed-icons-version',
						'type'     => 'select',
						'title'    => esc_html__('Choose sticky header icons version', 'ninzio-addons'),
						'options'  => array(
							"dark"  => "Dark",
					...
					array(
						'id'       =>'h2-desk-fixed-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h2-desk-fixed-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle border color', 'ninzio-addons'), 
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'h3-desk-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h3-desk-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header sidebar toggle border color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h3-desk-separator-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header menu icons separator color', 'ninzio-addons'), 
					),
					...
					array(
						'id'       =>'h3-desk-submenu-effect-color',
						'type'     => 'color',
						'title'    => esc_html__('Header submenu effect color', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),
					...
					array(
						'id'       =>'h3-desk-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
					...
					array(
						'id'       =>'h3-desk-megamenu-top-border',
						'type'     => 'color',
						'title'    => esc_html__('Megamenu top level border bottom', 'ninzio-addons'), 
					),
					...
					array(
						'id'       =>'h3-desk-megamenu-submenu-hover-effect',
						'type'     => 'select',
						'title'    => esc_html__('Choose megamenu submenu hover effect', 'ninzio-addons'),
						'options'  => array(
							'underline' =>'Underline',
					...
					array(
						'id'       =>'h3-megamenu-buttons-back-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons background color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#f0634c',
					),
					...
					array(
						'id'       =>'h3-megamenu-buttons-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Header buttons text color for megamenu widgets', 'ninzio-addons'), 
						'default'  => '#ffffff',
					),
					...
					array(
						'id'       =>'h3-desk-fixed-social-links-color',
						'type'     => 'color',
						'title'    => esc_html__('Header social links color', 'ninzio-addons'), 
						'default'  => '#999999',
					),
					...
					array(
						'id'       =>'h3-desk-fixed-sidebar-toggle-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle background color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h3-desk-fixed-sidebar-toggle-border-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Sticky header sidebar toggle border color', 'ninzio-addons'), 
					),

					array(
						'id'       =>'h3-desk-fixed-separator-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Header menu icons separator color', 'ninzio-addons'), 
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'footer-editor',
						'type'     => 'editor',
						'title'    => esc_html__('Footer content area', 'ninzio-addons'), 
					...
					array(
						...
						'type'     => 'background', 
						'title'    => esc_html__('Footer background image', 'ninzio-addons'),
					),

					array(
						'id'       =>'footer-copy',
						'type'     => 'textarea',
						'title'    => esc_html__('Footer copyright', 'ninzio-addons'), 
					),
				)
			);
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'blog-breadcrumbs-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Blog page breadcrumbs color', 'ninzio-addons'),
					),

					array(
						'id'       =>'blog-breadcrumbs-back-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Blog page breadcrumbs background color', 'ninzio-addons'),
					),
					...
					array(
						'id'      =>'blog-author',
						'type'    =>'switch', 
						'title'   => esc_html__('Author box', 'ninzio-addons'),
						'subtitle' => esc_html__('Toggle author info on single post page', 'ninzio-addons'),
						"default" => 1,
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'projects-back',
						'type'     => 'background',
						'title'    => esc_html__('Projects page title options', 'ninzio-addons'),
					),

					array(
						'id'       =>'projects-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Projects page title color', 'ninzio-addons'),
					),

					array(
						'id'       =>'projects-breadcrumbs-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Projects page breadcrumbs color', 'ninzio-addons'),
					),

					array(
						'id'       =>'projects-breadcrumbs-back-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Projects page breadcrumbs background color', 'ninzio-addons'),
					),

					array(
						'id'      =>'projects-parallax',
						'type'    => 'switch', 
						'title'   => esc_html__('Parallax effect for projects page header section', 'ninzio-addons'),
						"default" => 0,
					),
					...
					array(
						'id'      =>'projects-layout-single',
						'type'     => 'select',
						'title'    => esc_html__('Choose projects layout for single project page', 'ninzio-addons'),
						'options'  => array(
							"sidebar" => "sidebar",
							"whole"   => "whole",
						),
					...
					array(
						'id'       =>'projects-caption-color',
						'type'     => 'color',
						'title'    => esc_html__('Projects caption color', 'ninzio-addons'),
						'subtitle' => esc_html__('In projects archive page for some image based layouts you have option to choose caption color', 'ninzio-addons'),
					),
					...
					array(
						...
						'type'     => 'slider',
						'title'    => esc_html__('Set projects per page option', 'ninzio-addons'),
						'min'      =>'1', 
						'max'      =>'999', 
						'step'     =>'1',
						'default'  =>'12'
					...
					array(
						'id'      =>'projects-filter',
						'type'    =>'switch', 
						'title'   => esc_html__('Filter', 'ninzio-addons'),
						"default" => 0
					),
					...
					array(
						...
						'type'    =>'select', 
						'title'   => esc_html__('Projects navigation in archive', 'ninzio-addons'),
						'options'  => array(
							"none"       => "None",
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'shop-breadcrumbs-text-color',
						'type'     => 'color',
						'title'    => esc_html__('Shop page breadcrumbs color', 'ninzio-addons'),
					),

					array(
						'id'       =>'shop-breadcrumbs-back-color',
						'type'     => 'color_rgba',
						'title'    => esc_html__('Shop page breadcrumbs background color', 'ninzio-addons'),
					),
					...
					array(
						...
						'type'     => 'slider',
						'title'    => esc_html__('Set products per page option', 'ninzio-addons'),
						'min'      =>'1', 
						'max'      =>'999', 
						'step'     =>'1',
						'default'  =>'6'
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => esc_html__('Available only for Page title section version 2/3. (Theme options >> General >> Page title section)', 'ninzio-addons'),
					),
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'admin_bar'         => true,
                'global_variable'   => 'montserrat_ninzio',
                'dev_mode'          => false,
